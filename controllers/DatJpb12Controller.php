...
use app\models\DatJpb12Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DatJpb12Controller implements the CRUD actions for DatJpb12 model.
 */
class DatJpb12Controller extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all DatJpb12 models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DatJpb12Search();
    ...
    /**
     * Displays a single DatJpb12 model.
    ...
    /**
     * Updates an existing DatJpb12 model.
    ...
    /**
     * Deletes an existing DatJpb12 model.
    ...
    /**
     * Finds the DatJpb12 model based on its primary key value.
     ...
     * @param string $KD_JNS_OP
     * @param integer $NO_BNG
     * @return DatJpb12 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($KD_PROPINSI, $KD_DATI2, $KD_KECAMATAN, $KD_KELURAHAN, $KD_BLOK, $NO_URUT, $KD_JNS_OP, $NO_BNG)
    {
        if (($model = DatJpb12::findOne(['KD_PROPINSI' => $KD_PROPINSI, 'KD_DATI2' => $KD_DATI2, 'KD_KECAMATAN' => $KD_KECAMATAN, 'KD_KELURAHAN' => $KD_KELURAHAN, 'KD_BLOK' => $KD_BLOK, 'NO_URUT' => $NO_URUT, 'KD_JNS_OP' => $KD_JNS_OP, 'NO_BNG' => $NO_BNG])) !== null) {
            return $model;
        }
