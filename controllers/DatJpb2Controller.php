...
use app\models\DatJpb2Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DatJpb2Controller implements the CRUD actions for DatJpb2 model.
 */
class DatJpb2Controller extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all DatJpb2 models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DatJpb2Search();
    ...
    /**
     * Displays a single DatJpb2 model.
    ...
    /**
     * Updates an existing DatJpb2 model.
    ...
    /**
     * Deletes an existing DatJpb2 model.
    ...
    /**
     * Finds the DatJpb2 model based on its primary key value.
     ...
     * @param string $KD_JNS_OP
     * @param integer $NO_BNG
     * @return DatJpb2 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($KD_PROPINSI, $KD_DATI2, $KD_KECAMATAN, $KD_KELURAHAN, $KD_BLOK, $NO_URUT, $KD_JNS_OP, $NO_BNG)
    {
        if (($model = DatJpb2::findOne(['KD_PROPINSI' => $KD_PROPINSI, 'KD_DATI2' => $KD_DATI2, 'KD_KECAMATAN' => $KD_KECAMATAN, 'KD_KELURAHAN' => $KD_KELURAHAN, 'KD_BLOK' => $KD_BLOK, 'NO_URUT' => $NO_URUT, 'KD_JNS_OP' => $KD_JNS_OP, 'NO_BNG' => $NO_BNG])) !== null) {
            return $model;
        }
