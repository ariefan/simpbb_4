...
use app\models\DatJpb4Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DatJpb4Controller implements the CRUD actions for DatJpb4 model.
 */
class DatJpb4Controller extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all DatJpb4 models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DatJpb4Search();
    ...
    /**
     * Displays a single DatJpb4 model.
    ...
    /**
     * Updates an existing DatJpb4 model.
    ...
    /**
     * Deletes an existing DatJpb4 model.
    ...
    /**
     * Finds the DatJpb4 model based on its primary key value.
     ...
     * @param string $KD_JNS_OP
     * @param integer $NO_BNG
     * @return DatJpb4 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($KD_PROPINSI, $KD_DATI2, $KD_KECAMATAN, $KD_KELURAHAN, $KD_BLOK, $NO_URUT, $KD_JNS_OP, $NO_BNG)
    {
        if (($model = DatJpb4::findOne(['KD_PROPINSI' => $KD_PROPINSI, 'KD_DATI2' => $KD_DATI2, 'KD_KECAMATAN' => $KD_KECAMATAN, 'KD_KELURAHAN' => $KD_KELURAHAN, 'KD_BLOK' => $KD_BLOK, 'NO_URUT' => $NO_URUT, 'KD_JNS_OP' => $KD_JNS_OP, 'NO_BNG' => $NO_BNG])) !== null) {
            return $model;
        }
