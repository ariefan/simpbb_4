...
use app\models\DatJpb6Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DatJpb6Controller implements the CRUD actions for DatJpb6 model.
 */
class DatJpb6Controller extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all DatJpb6 models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DatJpb6Search();
    ...
    /**
     * Displays a single DatJpb6 model.
    ...
    /**
     * Updates an existing DatJpb6 model.
    ...
    /**
     * Deletes an existing DatJpb6 model.
    ...
    /**
     * Finds the DatJpb6 model based on its primary key value.
     ...
     * @param string $KD_JNS_OP
     * @param integer $NO_BNG
     * @return DatJpb6 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($KD_PROPINSI, $KD_DATI2, $KD_KECAMATAN, $KD_KELURAHAN, $KD_BLOK, $NO_URUT, $KD_JNS_OP, $NO_BNG)
    {
        if (($model = DatJpb6::findOne(['KD_PROPINSI' => $KD_PROPINSI, 'KD_DATI2' => $KD_DATI2, 'KD_KECAMATAN' => $KD_KECAMATAN, 'KD_KELURAHAN' => $KD_KELURAHAN, 'KD_BLOK' => $KD_BLOK, 'NO_URUT' => $NO_URUT, 'KD_JNS_OP' => $KD_JNS_OP, 'NO_BNG' => $NO_BNG])) !== null) {
            return $model;
        }
