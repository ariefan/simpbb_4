...
use app\models\DatJpb8Search;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DatJpb8Controller implements the CRUD actions for DatJpb8 model.
 */
class DatJpb8Controller extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all DatJpb8 models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DatJpb8Search();
    ...
    /**
     * Displays a single DatJpb8 model.
    ...
    /**
     * Updates an existing DatJpb8 model.
    ...
    /**
     * Deletes an existing DatJpb8 model.
    ...
    /**
     * Finds the DatJpb8 model based on its primary key value.
     ...
     * @param string $KD_JNS_OP
     * @param integer $NO_BNG
     * @return DatJpb8 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($KD_PROPINSI, $KD_DATI2, $KD_KECAMATAN, $KD_KELURAHAN, $KD_BLOK, $NO_URUT, $KD_JNS_OP, $NO_BNG)
    {
        if (($model = DatJpb8::findOne(['KD_PROPINSI' => $KD_PROPINSI, 'KD_DATI2' => $KD_DATI2, 'KD_KECAMATAN' => $KD_KECAMATAN, 'KD_KELURAHAN' => $KD_KELURAHAN, 'KD_BLOK' => $KD_BLOK, 'NO_URUT' => $NO_URUT, 'KD_JNS_OP' => $KD_JNS_OP, 'NO_BNG' => $NO_BNG])) !== null) {
            return $model;
        }
