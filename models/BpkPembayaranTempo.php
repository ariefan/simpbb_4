...
/**
 * This is the model class for table "bpk_pembayaran_tempo".
 *
 ...
 */
class BpkPembayaranTempo extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'TGL_JATUH_TEMPO_SPPT', 'THN_PAJAK_SPPT', 'PIUTANG', 'POKOK_TERBAYAR', 'DENDA_TERBAYAR', 'SISA_PIUTANG'], 'required'],
            ...
            [['THN_PAJAK_SPPT'], 'string', 'max' => 400],
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'TGL_JATUH_TEMPO_SPPT'], 'unique', 'targetAttribute' => ['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'TGL_JATUH_TEMPO_SPPT']],
        ];
    }
