...
/**
 * DatJpb13Search represents the model behind the search form of `app\models\DatJpb13`.
 */
class DatJpb13Search extends DatJpb13
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'KLS_JPB13'], 'safe'],
            [['NO_BNG'], 'integer'],
