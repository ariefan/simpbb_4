...
/**
 * This is the model class for table "dat_jpb15".
 *
 ...
 * @property string $KAPASITAS_TANGKI_JPB15
 */
class DatJpb15 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['KD_JNS_OP', 'LETAK_TANGKI_JPB15'], 'string', 'max' => 1],
