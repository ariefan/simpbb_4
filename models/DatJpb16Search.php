...
/**
 * DatJpb16Search represents the model behind the search form of `app\models\DatJpb16`.
 */
class DatJpb16Search extends DatJpb16
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'KLS_JPB16'], 'safe'],
            [['NO_BNG'], 'integer'],
        ];
    }
