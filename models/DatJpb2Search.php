...
/**
 * DatJpb2Search represents the model behind the search form of `app\models\DatJpb2`.
 */
class DatJpb2Search extends DatJpb2
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'KLS_JPB2'], 'safe'],
            [['NO_BNG'], 'integer'],
        ];
    }
