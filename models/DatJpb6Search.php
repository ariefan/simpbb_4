...
/**
 * DatJpb6Search represents the model behind the search form of `app\models\DatJpb6`.
 */
class DatJpb6Search extends DatJpb6
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'KLS_JPB6'], 'safe'],
            [['NO_BNG'], 'integer'],
        ];
    }
