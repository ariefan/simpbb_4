...
/**
 * DatJpb9Search represents the model behind the search form of `app\models\DatJpb9`.
 */
class DatJpb9Search extends DatJpb9
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'KLS_JPB9'], 'safe'],
            [['NO_BNG'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'KD_PROPINSI', $this->KD_PROPINSI])
            ...
            ->andFilterWhere(['like', 'KLS_JPB9', $this->KLS_JPB9]);
