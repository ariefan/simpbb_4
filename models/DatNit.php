...
/**
 * This is the model class for table "dat_nit".
 *
 ...
 * @property int $NIT
 * @property string $NM_PENDATA
 * @property string $NIP_PENDATA
 */
class DatNit extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['NM_PENDATA', 'NIP_PENDATA'], 'string', 'max' => 50],
