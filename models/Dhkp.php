...
/**
 * This is the model class for table "dhkp".
 *
 ...
 */
class Dhkp extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['LUAS_BUMI_SPPT', 'LUAS_BNG_SPPT', 'NJOP_BUMI_SPPT', 'NJOP_BNG_SPPT', 'NJOPTKP_SPPT', 'PBB_TERHUTANG'], 'integer'],
