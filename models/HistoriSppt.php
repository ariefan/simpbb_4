...
/**
 * This is the model class for table "histori_sppt".
 *
 ...
 * @property int $THN_AWAL_KLS_TANAH
 * @property string $KD_KLS_BNG
 * @property int $THN_AWAL_KLS_BNG
 ...
 * @property string $NAMA_PENCETAK_SPPT
 */
class HistoriSppt extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'THN_PAJAK_SPPT', 'SIKLUS_SPPT'], 'required'],
            [['THN_PAJAK_SPPT', 'SIKLUS_SPPT', 'THN_AWAL_KLS_TANAH', 'THN_AWAL_KLS_BNG', 'LUAS_BUMI_SPPT', 'LUAS_BNG_SPPT', 'NJOP_BUMI_SPPT', 'NJOP_BNG_SPPT', 'NJOP_SPPT', 'NJOPTKP_SPPT', 'NJKP_SPPT', 'PBB_TERHUTANG_SPPT', 'FAKTOR_PENGURANG_SPPT', 'PBB_YG_HARUS_DIBAYAR_SPPT', 'STATUS_PEMBAYARAN_SPPT', 'STATUS_TAGIHAN_SPPT', 'STATUS_CETAK_SPPT'], 'integer'],
            ...
            [['NAMA_PENCETAK_SPPT'], 'string', 'max' => 100],
            [['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'THN_PAJAK_SPPT', 'SIKLUS_SPPT'], 'unique', 'targetAttribute' => ['KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'THN_PAJAK_SPPT', 'SIKLUS_SPPT']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'NAMA_PENCETAK_SPPT' => 'Nama Pencetak Sppt',
        ];
    }
}
