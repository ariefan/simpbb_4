...
/**
 * This is the model class for table "log_dat_op_bangunan".
 *
 * @property int $ID_LOG
 ...
 * @property int $AKTIF
 */
class LogDatOpBangunan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['TANGGAL_LOG', 'TGL_KUNJUNGAN_KEMBALI', 'TGL_PENDATAAN_BNG', 'TGL_PEMERIKSAAN_BNG'], 'safe'],
            ...
            [['NM_PENDATAAN_OP', 'NM_PEMERIKSAAN_OP'], 'string', 'max' => 30],
            [['NIP_PENDATA_BNG', 'NIP_PEMERIKSA_BNG'], 'string', 'max' => 20],
        ];
    }
