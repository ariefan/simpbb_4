...
/**
 * This is the model class for table "log_spop".
 *
 * @property int $ID_LOG
 ...
 */
class LogSpop extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['TANGGAL_LOG', 'KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'SUBJEK_PAJAK_ID', 'JNS_TRANSAKSI_OP', 'JALAN_OP', 'KD_STATUS_WP', 'LUAS_BUMI', 'JNS_BUMI', 'TGL_PENDATAAN_OP', 'TGL_PEMERIKSAAN_OP'], 'required'],
            [['TANGGAL_LOG', 'TGL_PENDATAAN_OP', 'TGL_PEMERIKSAAN_OP'], 'safe'],
            ...
            [['NIP_PENDATA'], 'string', 'max' => 200],
            [['NIP_PEMERIKSA_OP'], 'string', 'max' => 20],
        ];
    }
