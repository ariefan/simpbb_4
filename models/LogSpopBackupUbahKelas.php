...
/**
 * This is the model class for table "log_spop_backup_ubah_kelas".
 *
 ...
 */
class LogSpopBackupUbahKelas extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'log_spop_backup_ubah_kelas';
    }
    ...
    {
        return [
            [['id_riwayat', 'LUAS_BUMI', 'NILAI_SISTEM_BUMI'], 'integer'],
