...
/**
 * This is the model class for table "log_sppt".
 *
 * @property int $ID_LOG
 ...
 */
class LogSppt extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['TANGGAL_LOG', 'AKSI', 'KD_PROPINSI', 'KD_DATI2', 'KD_KECAMATAN', 'KD_KELURAHAN', 'KD_BLOK', 'NO_URUT', 'KD_JNS_OP', 'THN_PAJAK_SPPT'], 'required'],
            [['TANGGAL_LOG', 'THN_PAJAK_SPPT', 'THN_AWAL_KLS_TANAH', 'THN_AWAL_KLS_BNG', 'TGL_JATUH_TEMPO_SPPT', 'TGL_TERBIT_SPPT', 'TGL_CETAK_SPPT'], 'safe'],
