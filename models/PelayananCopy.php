...
/**
 * This is the model class for table "pelayanan_copy".
 *
 * @property int $ID
 ...
 */
class PelayananCopy extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['TANGGAL_PELAYANAN', 'TANGGAL_PERKIRAAN_SELESAI', 'TGL_MASUK_PENILAI', 'TGL_SELESAI', 'TGL_TERKONFIRMASI_WP'], 'safe'],
