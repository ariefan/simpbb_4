...
/**
 * This is the model class for table "sppt_2019".
 *
 ...
 */
class Sppt2019 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['THN_AWAL_KLS_TANAH', 'THN_AWAL_KLS_BNG', 'TGL_JATUH_TEMPO_SPPT', 'TGL_TERBIT_SPPT', 'TGL_CETAK_SPPT'], 'safe'],
