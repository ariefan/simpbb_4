...
/**
 * This is the model class for table "sppt_penyalinan".
 *
 ...
 * @property string $TANGGAL_PENYALINAN
 * @property string $NIP_PENYALIN
 * @property string $ALASAN_PENYALINAN
 * @property int $ID
 */
class SpptPenyalinan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['TGL_JATUH_TEMPO_SPPT', 'TGL_TERBIT_SPPT', 'TGL_CETAK_SPPT', 'TANGGAL_PENYALINAN'], 'safe'],
            [['ALASAN_PENYALINAN'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'TANGGAL_PENYALINAN' => 'Tanggal Penyalinan',
            'NIP_PENYALIN' => 'Nip Penyalin',
            'ALASAN_PENYALINAN' => 'Alasan Penyalinan',
            'ID' => 'ID',
        ];
    }
}
