...
/* @var $model app\models\DatJpb12 */

$this->title = 'Update Dat Jpb12: ' . $model->KD_PROPINSI;
$this->params['breadcrumbs'][] = ['label' => 'Dat Jpb12s', 'url' => ['index']];
...
?>
<div class="card dat-jpb12-update">
