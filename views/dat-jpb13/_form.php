...
<div class="dat-jpb13-form">
    ...
    <?= $form->field($model, 'KLS_JPB13')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'JML_JPB13')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'LUAS_JPB13_DGN_AC_SENT')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'LUAS_JPB13_LAIN_DGN_AC_SENT')->textInput(['maxlength' => true]) ?>
