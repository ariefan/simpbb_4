...
/* @var $model app\models\DatJpb5 */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="dat-jpb5-form">
    ...
    <?= $form->field($model, 'KLS_JPB5')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'LUAS_KMR_JPB5_DGN_AC_SENT')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'LUAS_RNG_LAIN_JPB5_DGN_AC_SENT')->textInput(['maxlength' => true]) ?>
