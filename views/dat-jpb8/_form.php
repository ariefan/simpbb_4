...
<div class="dat-jpb8-form">
    ...
    <?= $form->field($model, 'TING_KOLOM_JPB8')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'LBR_BENT_JPB8')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'LUAS_MEZZANINE_JPB8')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'KELILING_DINDING_JPB8')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'DAYA_DUKUNG_LANTAI_JPB8')->textInput(['maxlength' => true]) ?>
