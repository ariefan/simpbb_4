...
$this->title = "Informasi Hasil Input Pelayanan ".$data['KD_PROPINSI'].$data['KD_DATI2'].$data['KD_KECAMATAN'].$data['KD_KELURAHAN'].$data['KD_BLOK'].$data['NO_URUT'].$data['KD_JNS_OP'];
...
<div class="row">	
	...
	<table cellspacing="0" cellpadding="0" border="0px" width="100%" style="font-size:14px;font-family:tahoma;">
		<tr><td colspan="6" style="font-weight: bold;">&emsp; &emsp; Sebelum Pelayanan :</td></tr>
...
<div class="row">
	...
	<br/>
	<table cellspacing="0" cellpadding="0" border="0px" width="100%" style="font-size:14px;font-family:tahoma;">
		<tr><td colspan="6" style="font-weight: bold;">&emsp; &emsp; Hasil Input Pelayanan :</td></tr>
		<tr><td width="30%">&emsp; &emsp; Nomor Objek Pajak</td><td colspan="5">: <?= $data['KD_PROPINSI'].'.'.$data['KD_DATI2'].'.'.$data['KD_KECAMATAN'].'.'.$data['KD_KELURAHAN'].'.'.$data['KD_BLOK'].'-'.$data['NO_URUT'].'.'.$data['KD_JNS_OP'] ?></td></tr>
...
<!--
	<tr><td>NJOP Bumi (Rp.)</td><td>: <?= number_format($data['LUAS_BUMI_BARU'],0,'','.') ?> m<sup>2</sup> </td><td>x</td><td>  <?= number_format($data['NJOP_BUMI_TOTAL_BARU']/$data['LUAS_BUMI_BARU'],0,'','.') ?>  </td> <td>=</td> <td><?= number_format($data['NJOP_BUMI_TOTAL_BARU'],0,'','.') ?></td></tr>
