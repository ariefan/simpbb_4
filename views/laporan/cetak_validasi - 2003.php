...
$this->title = "Validasi ".$data1[0]['KD_PROPINSI'].$data1[0]['KD_DATI2'].$data1[0]['KD_KECAMATAN'].$data1[0]['KD_KELURAHAN'].$data1[0]['KD_BLOK'].$data1[0]['NO_URUT'].$data1[0]['KD_JNS_OP'];
...
<div class="row">
	...
	<table cellspacing="0px" cellpadding="0px" border="0px" width="80%" style="font-size:12px;margin-left:40px;line-height:1px;">	
...
<div class="row">
	...
	<table bordercolor="#999999" border="0" style="font-size:12px;" width="100%">
		<tr height='15px'>
			<td style="text-align:left; ">
				<label style="font-size:12px;padding-left:20px;font-weight:normal;"><input type="checkbox" name="checkbox" value="value" style="width:20px;height:20px;display:inline-block;line-height:20px;font-size:12px;vertical-align:bottom;"> Kode 1, Objek Pajak tidak dapat ditemukan lokasinya dilapangan</label>
			</td>
		</tr>
		<tr height='15px'>
			<td style="text-align:left; ">
				<label style="font-size:12px;padding-left:20px;font-weight:normal;"><input type="checkbox" name="checkbox" value="value" style="width:20px;height:20px;display:inline-block;line-height:20px;font-size:12px;vertical-align:bottom;"> Kode 2, Objek Pajak memiliki dua atau lebih NOP untuk lokasi yang sama</label>
			</td>
		</tr>
		<tr height='15px'>
			<td style="text-align:left; ">
				<label style="font-size:12px;padding-left:20px;font-weight:normal;"><input type="checkbox" name="checkbox" value="value" style="width:20px;height:20px;display:inline-block;line-height:20px;font-size:12px;vertical-align:bottom;"> Kode 3, Objek Pajak yang subjek pajaknya tidak dapat teridentifikasi dengan jelas atau objek pajak sudah terjual</label>
			</td>
		</tr>
		<tr height='15px'>
			<td style="text-align:left; ">
				<label style="font-size:12px;padding-left:20px;font-weight:normal;"><input type="checkbox" name="checkbox" value="value" style="width:20px;height:20px;display:inline-block;line-height:20px;font-size:12px;vertical-align:bottom;"> Kode 4, Objek Pajak yang subjek pajaknya teridentifikasi dengan jelas</label>
			</td>
		</tr>
		<tr height='15px'>
			<td style="text-align:left; ">
				<label style="font-size:12px;padding-left:20px;font-weight:normal;"><input type="checkbox" name="checkbox" value="value" style="width:20px;height:20px;display:inline-block;line-height:20px;font-size:12px;vertical-align:bottom;"> Kode 5, Objek Pajak dan subjek pajaknya teridentifikasi tetapi data tidak sesuai</label>
			</td>
		</tr>
	</table>
</div>
...
<div class="row">
	...
	<table bordercolor="#E6E6E6" border="0" style="font-size:12px;" width="100%">
		<tbody>			
			<tr height='25px'>
				<td width='33%' style="text-align:center; ">Menyetujui Hasil Validasi<br/>Wajib Pajak<br/><br/><br/><br/>(...........................................................)</td><td width='33%' style="text-align:center; " colspan="2"><br/>Petugas<br/><br/><br/><br/>(...........................................................)</td><td width='33%' style="text-align:center; "><br/>Koordinator<br/><br/><br/><br/>(...........................................................)</td>
			</tr>
			<tr height='15px'>
				<td style="text-align:left;" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No HP :</td>
			</tr>
			<tr height='15px'>
				<td style="text-align:left;" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Alamat :</td>
			</tr>			
			<tr height='40px'>
				<td style="text-align:center;" colspan="4">Mengetahui</td>
			</tr>
			<tr height='25px'>
				<td width='100%' style="text-align:center;" colspan="4">Kadus / Kaling<br/><br/><br/><br/><br/>(...........................................................)</td>
			</tr>
		</tbody>
	</table>
</div>
