      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          <ul class="nav">
            ...
            <li class="nav-title">PBB</li>
            <li class="nav-item nav-dropdown">
              <a class="nav-link nav-dropdown-toggle" href="#">
                <i class="nav-icon icon-puzzle"></i> Menu</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" href="<?= Url::toRoute(['/pelayanan/index']) ?>"><i class="nav-icon icon-puzzle"></i> Pelayanan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?= Url::toRoute(['/spop/index']) ?>"><i class="nav-icon icon-puzzle"></i> SPOP</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?= Url::toRoute(['/dat-op-bangunan/index']) ?>"><i class="nav-icon icon-puzzle"></i> LSPOP</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?= Url::toRoute(['/laporan/index']) ?>"><i class="nav-icon icon-puzzle"></i> Laporan</a>
                </li>
              </ul>
            </li>
          </ul>
