...
<table class="table" style="margin-top: 0px;">
	<tr>
		<td width="20%" style="vertical-align: middle;"><img src="<?= Yii::getAlias('@web/images/logo-small.png',true) ?>" width="90px"/></td>
		<td><center><h2 style="font-size: 18px;margin-bottom: 0px">
		  PEMERINTAH <?= $konfigurasi->kabupaten_kop ?><br/>
		  <?= $konfigurasi->instansi_kop ?></h2><span style="font-size: 14px">JL. Letda Tantular NO. 12 Denpasar<br/>Telp. (0361) 239079.239080 Fax. (0361) 261246<br/>email: <?= $konfigurasi->email ?></span></center></td>
	    <td width="20%"></td>
	</tr>
</table>
<hr style="border:1px solid">
<center><h4>INFORMASI DATA PEMBAYARAN</h4></center>
<div class="row">
  <div class="col-xs-12" style="font-size:12px"><br/>
	  <table class="table">
		<tr>
			...
			<td style="border:none;padding:2px"><?php echo $data_objek['KD_PROPINSI'].'.'.$data_objek['KD_DATI2'].'.'.$data_objek['KD_KECAMATAN'].'.'.$data_objek['KD_KELURAHAN'].'.'.$data_objek['KD_BLOK'].'.'.$data_objek['NO_URUT'].'.'.$data_objek['KD_JNS_OP']; ?></td>
			
			<td style="border:none;padding:2px">Luas Bumi (m<sup>2</sup>)</td>
			<td style="border:none;padding:2px">:</td>
			<td style="border:none;padding:2px"><?php echo number_format($data_objek['LUAS_BUMI'], 0, "," , "." ); ?></td>
		</tr>
		<tr>
			<td style="border:none;padding:2px">Nama</td>
			<td style="border:none;padding:2px">:</td>
			<td style="border:none;padding:2px"><?php echo $data_subjek['NM_WP']; ?></td>
			<td style="border:none;padding:2px">NJOP Bumi (m<sup>2</sup>) / Kelas</td>
			<td style="border:none;padding:2px">:</td>
			<td style="border:none;padding:2px"><?php echo $data_objek['LUAS_BUMI'] == 0 ? $data_sppt[count($data_sppt)-1]['NJOP_BUMI_SPPT']. ' / '.$data_sppt[count($data_sppt)-1]['KD_KLS_TANAH'] : number_format($data_sppt[count($data_sppt)-1]['NJOP_BUMI_SPPT']/$data_objek['LUAS_BUMI'], 0, "," , "." ). ' / '.$data_sppt[count($data_sppt)-1]['KD_KLS_TANAH']; ?></td>
		</tr>
		<tr>
			<td style="border:none;padding:2px">Alamat WP</td>
			<td style="border:none;padding:2px">:</td>
			<td style="border:none;padding:2px"><?php echo $data_subjek['JALAN_WP'].' RT '. $data_subjek['RT_WP']. ' ' .$data_subjek['KELURAHAN_WP']; ?></td>
			<td style="border:none;padding:2px">Luas Bangunan (m<sup>2</sup>)</td>
			<td style="border:none;padding:2px">:</td>
			<td style="border:none;padding:2px"><?php echo number_format($data_sppt[count($data_sppt)-1]['LUAS_BNG_SPPT'], 0, "," , "." ); ?></td>
		</tr>
		<tr>
			<td style="border:none;padding:2px">Alamat OP</td>
			<td style="border:none;padding:2px">:</td>
			<td style="width: 250px;border:none;padding:2px" ><?php echo $data_objek['JALAN_OP'].' RT '. $data_objek['RT_OP'].' '.$kelurahan[$data_objek['KD_KECAMATAN']][$data_objek['KD_KELURAHAN']] ?></td>
			<td style="border:none;padding:2px">NJOP Bangunan (m<sup>2</sup>) / Kelas</td>
			<td style="border:none;padding:2px">:</td>
			<td style="border:none;padding:2px"><?php if($data_sppt[count($data_sppt)-1]['LUAS_BNG_SPPT']>0) echo number_format($data_sppt[count($data_sppt)-1]['NJOP_BNG_SPPT']/$data_sppt[count($data_sppt)-1]['LUAS_BNG_SPPT'], 0, "," , "." ). ' / '.$data_sppt[count($data_sppt)-1]['KD_KLS_BNG']; ?></td>
		</tr>
		<tr>
			<td style="border:none;padding:2px">Tanggal Printout</td>
			<td style="border:none;padding:2px">:</td>
			<td style="width: 250px;border:none;padding:2px" ><?= \app\models\SpptE::tglIndo(date('Y-m-d')) ?></td>
			<td style="border:none;padding:2px">Petugas Cetak</td>
			<td style="border:none;padding:2px">:</td>
			<td style="border:none;padding:2px"><?= Yii::$app->user->identity->nama_lengkap ?></td>
		</tr>
	  </table>	  
	</div>
</div>
...
<div class="row">
	<div class="col-xs-6">
		...
		<img style="text-align: center;" src="<?= Yii::getAlias('@web/images/i-PBB_Kota_Denpasar.png',true) ?>" width="110px"/>
	</div>
	<div class="col-xs-6" style="font-size:12px">
		<table class="table">
			<tr>			
				<th style="border:1px solid;padding:2px" colspan="2"><center>TOTAL TAGIHAN</center></th>
			</tr>
			<tr>
		...
		<table>
			<tr>
				<th style="text-align:center">Kota Denpasar, <?= \app\models\SpptE::tglIndo(date('Y-m-d')) ?></th>
			</tr>
			<tr>
			...
			<tr>
				<th style="text-align:center"><?= Yii::$app->user->identity->nama_lengkap ?></th>
			</tr>
